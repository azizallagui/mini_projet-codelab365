      ...
      <div class="">
        <form method="POST"  action="../../Controller/modifierEvenement.php">
          ...
          <div class="row clearfix">
            ...
            <div class="col_half">
              <div class="input_field"> <span><i aria-hidden="true" ></i></span>
                <input type="text" name="adresse_event"  placeholder="localisation" required value="<?php echo $evenement['adresse_event']; ?>" required />
              </div>
            </div>
            <div class="col_half">
              <div class="input_field"> <span><i aria-hidden="true" ></i></span>
                <input type="date" name="date_debut"  placeholder="date événement" required value="<?php echo $evenement['date_debut']; ?>" />
              </div>
          </div>
          <div class="col_half">
              <div class="input_field"> <span><i aria-hidden="true" ></i></span>
                <input type="text" name="information_event"  placeholder="description événement" required value="<?php echo $evenement['information_event']; ?>" />
              </div>

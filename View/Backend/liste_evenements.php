...
<?php
  ...
  {  
      $listeevent=$EvenementC->Findevent($_POST["nom_event"],$_POST["adresse_event"]);
...
<div class='table-responsive'>
    ...
    <a  type="text" id="myInput" href="tri.php"  class="btn btn-primary" title="trier">trier par nom</a>
           <?php
			...
			<tr>
				...
				<td><?php echo $evenement['adresse_event']; ?></td>
				<td><?php echo $evenement['date_debut']; ?></td>
				<td><?php echo $evenement['information_event']; ?></td>
                <td>
 ...
 ?>
 <div class="input_field"> <span><i aria-hidden="true"></i></span>
            <input type="text" name="adresse_event" placeholder="adresse_event" required />
          </div> 
		  <div class="input_field"> <span><i aria-hidden="true"></i></span>
            <input type="DATE" name="date_debut" placeholder="jj/mm/aa" required />
          </div>
		  
              <div class="input_field"> <span><i aria-hidden="true" ></i></span>
              <textarea type ="text" name="information_event"  style="width: 350px; padding-left: 30px" placeholder="discription"> 
 </textarea>
              </div>
            </div>

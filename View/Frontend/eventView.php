        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-md-block">
              ...
              <a href="participer.php" class="fadeInLeft wow btn btn-common btn-lg" data-wow-delay=".6s">participer</a>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-md-block">
              <p class="fadeInUp wow" data-wow-delay=".6s">Grand événement mondial sur mode et beauté</p>
              <h1 class="wow bounceIn heading" data-wow-delay=".7s">Grand événement mondial sur mode et beauté</h1>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-md-block">
              ...
              <a href="participer.php" class="fadeInUp wow btn btn-common btn-lg" data-wow-delay=".8s">PARTICIPER</a>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 col-xs-12 work-counter-widget text-center">
            <div class="counter wow fadeInRight" data-wow-delay="0.3s">
              ...
              <p>codelab360</p>
              <span>achères,ils de france </span>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 col-xs-12 work-counter-widget text-center">
